                  ...
                  <div class="flex flex-col px-2 py-2">
                   <!-- カラム１ -->
                    ...
                    <div class="w-full md:w-1/1 px-3 mb-2 md:mb-0">
                      ...
                      <input name="is_public" class="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="">
                    </div>
                  </div>
                  <!-- カラム５ -->
